DROP FUNCTION TicketFullPrice;

DELIMITER //
CREATE FUNCTION TicketFullPrice(vFlightID INT, vSeatNo VARCHAR(4)) RETURNS DECIMAL(8,2)
BEGIN
	DECLARE vBasePrice DECIMAL(8,2);
	DECLARE vLuggagePrice DECIMAL(8,2);
	DECLARE vMealPrice DECIMAL(8,2);
